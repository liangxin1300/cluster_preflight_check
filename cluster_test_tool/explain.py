...
kill_sbd = '''
On {nodeA}, once the sbd process get killed, there are two situations:
...
kill_sbd_l = '''
On {nodeA}, the sbd service is killed consistantly all the time. 
...
kill_corosync = '''
On {nodeA}, once the corosync process get killed, systemd will restart corosync service immediately. There are two situations:
...
kill_corosync_l = '''
The corosync service is killed consistantly all the time.
