...
import logging
import datetime
from cluster_test_tool import utils, main
...
class TestUtils(unittest.TestCase):
    ...
    @mock.patch('cluster_test_tool.utils.now')
    ...
    @mock.patch('cluster_test_tool.utils.msg_raw')
    ...
    @mock.patch('cluster_test_tool.utils.msg_info')
    ...
    @mock.patch('cluster_test_tool.utils.msg_warn')
    ...
    @mock.patch('cluster_test_tool.utils.msg_error')
